<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="9.aspx.cs" Inherits="Assignment___2_Database_Programming_and_Entity_Framework._9" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="inBody" runat="server">
    <h2>
        9. Write a program to demonstrate update and delete operation in connected architecture
